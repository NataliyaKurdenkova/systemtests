package ru.webtest.springbootweb_test.services;
...
public class signInService {
    ...
    public static void recoveryPassLinkCreateAndSend (String login, Long idUser) throws MessagingException {
        ...
        //Текст письма
        message.setText("Поступил запрос на восстановление пароля. Для этого перейдите по ссылке: http://localhost:8081/updatePass?" + idUser);
        //Поехали!!!
